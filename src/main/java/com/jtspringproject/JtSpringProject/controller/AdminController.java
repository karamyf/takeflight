...
public class AdminController {
	...
	public String processPayment(@RequestParam("first-name") String firstName, @RequestParam("last-name") String lastName, @RequestParam String number,
		...
		try {
			...
			PreparedStatement pst = conn.prepareStatement("insert into payments(first_name, last_name, card_number, expiry_date, cvc, street_address, city, zip_code, email,username) values(?,?,?,?,?,?,?,?,?,?);");
			...
			String username = usernameforclass;
